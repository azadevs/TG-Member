...
object TgMemberStr {
    ...
    init {
        ...
        titlesLanguages.add(
            TitleLanguages(
                5,
                "Enter email and vip number for transfer",
                "Ko'chirish uchun electron pochta va vip lar sonini kiriting",
                "Введите адрес электронной почты и количество вип-персон для переноса."
            )
        )
        titlesLanguages.add(
            TitleLanguages(
        ...
        titlesLanguages.add(
            TitleLanguages(
                7,
                "Enter vip number",
                "Vip lar sonini kiriting",
                "Введите количество вип-персон"
            )
        )
        ...
        titlesLanguages.add(
            TitleLanguages(
                ...
                "E-mail addressinginzni kiriting",
        ...
        titlesLanguages.add(
            TitleLanguages(
                18,
                "Enter your email address, then click the button. A verification code will be sent to your email, which you will then need to enter.",
                "Elektron pochta manzilingizni kiriting, so'ng tugmani bosing. Tasdiqlash kodi elektron pochtangizga yuboriladi, keyin uni kiritishingiz kerak bo'ladi.",
                "Введите свой адрес электронной почты, затем нажмите кнопку. На вашу электронную почту будет отправлен код подтверждения, который вам затем нужно будет ввести."
            )
        )
        ...
        titlesLanguages.add(
            TitleLanguages(
                22,
                "Email Copied",
                "Elektron pochtadan nusxa olindi",
        ...
        titlesLanguages.add(
            TitleLanguages(
                41,
                "Enter your channel link or username",
                "Kanalingiz havolasini yoki username kiriting",
                "Введите ссылку на ваш канал или имя пользователя"
            )
        )
        titlesLanguages.add(
            TitleLanguages(
        ...
        titlesLanguages.add(
            TitleLanguages(
                44,
                "Are you sure you want to send this channel?",
                "Ushbu kanalni yuborishga ishonchingiz komilmi?",
                "Вы уверены, что хотите отправить этот канал?"
            )
        )
        ...
        titlesLanguages.add(
            TitleLanguages(
                ...
                "Sizning elektron pochta manzilingiz o'zgartirildi",
        ...
        titlesLanguages.add(
            TitleLanguages(
                60,
                "Enter your channel link or username. Please check carefully and enter without errors.",
                "Kanalingiz havolasini yoki nomini kiriting. Iltimos yaxshilab tekshirib, xatosiz kiriting.",
                "Введите ссылку или название вашего канала. Пожалуйста, проверьте внимательно и введите без ошибок."
            )
        )
        titlesLanguages.add(
            TitleLanguages(
                61,
                "You don't have enough vips to buy this packet. Please go to the vip store to increase your vips number.",
                "Ushbu paketni sotib olish uchun sizda yetarli vip yo‘q. Iltimos, vip raqamingizni ko'paytirish uchun vip do'koniga o'ting.",
                "У вас недостаточно VIP-ов для покупки этого пакета. Пожалуйста, перейдите в магазин VIP-ов, чтобы увеличить количество VIP-ов."
            )
        )
        ...
        titlesLanguages.add(
            TitleLanguages(
                64,
                "Auto-join rule",
                "Avtomatik qo'shilish qoidasi",
                "Правило автоматического присоединения"
            )
        )
        titlesLanguages.add(
            TitleLanguages(
                65,
                "If you want to use the auto-join feature, you should not do the following while auto-join is running:\n" +
                        "* Exit and close the program;\n" +
                        "* Exit the program and log in to another program;\n" +
                        "* Delete your account;",
                "Agar siz avtomatik qo'shilish funksiyasidan foydalanmoqchi bo'lsangiz, u holda siz avtomatik qo'shilish ishlab turganida quyidagi harakatlarni qilmasliginiz kerak:\n" +
                        " * Dasturdan chiqib ketish va uni yopib qo'yish;\n" +
                        " * Dasturdan chiqib boshqa dasturga kirish;\n" +
                        " * Hisobingizni o'chirib tashlash;",
                "Если вы хотите использовать функцию автоматического присоединения, во время работы автоматического присоединения не следует выполнять следующие действия:\n" +
        ...
        titlesLanguages.add(
            TitleLanguages(
                ...
                "Xabaringiz havolasini kiriting",
                "Введите ссылку на ваш пост"
            )
        )
        titlesLanguages.add(
            TitleLanguages(
        ...
        titlesLanguages.add(
            TitleLanguages(
                ...
                "Iltimos, buyurtma berishdan oldin quyidagilarga ishonch hosil qiling:",
                "Перед размещением заказа убедитесь, что выполнены следующие условия:"
            )
        )
        titlesLanguages.add(
            TitleLanguages(
